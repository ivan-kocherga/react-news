  ...
  function submitForm() {
    ...
    if (isValidForm.current) {
      ...
      auth(obj)
        .then((res) => {
          alert.show(
            "Отлично! Добро пожаловать в умопомрачительный новостной сайт",
            {
              type: "success",
            }
          );
    ...
    <div className="auth">
      <div className="auth-wrapper">
        ...
        <div className="auth__email">
          ...
          />
          <div className="error-email">{emailError.join(" ")}</div>
        </div>
        ...
        <div className="auth__password">
          ...
          />
          <div
            onClick={() => SetIsWatchPassword(!watchPassword)}
            className="auth__password-btnPassword"
          >
            {watchPassword ? (
          ...
          <div className="error-password">{passwordError.join(" ")}</div>
        </div>

        <button className="auth__submit" onClick={submitForm}>
          Погнали дальше
        </button>
      </div>
